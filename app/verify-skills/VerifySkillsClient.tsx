...
export default function VerifySkillsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#fafaf9' }}>
      ...
      {/* What "verified" means */}
      <section className="relative px-6 md:px-12 lg:px-20 py-10 lg:py-14 overflow-hidden">
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <div className="max-w-2xl">
            <h2 className="text-2xl lg:text-3xl font-display tracking-tight mb-3" style={{ color: '#080503' }}>
              What does &quot;verified&quot; mean?
            </h2>
            <p className="text-base lg:text-lg leading-relaxed" style={{ color: '#57554f' }}>
              Each skill on your OnlyWorks report is corroborated against your real captured work — not self-reported, and not identity or cryptographic verification. If it&apos;s marked verified, an AI checked it against the work itself.
            </p>
          </div>
        </div>
      </section>
