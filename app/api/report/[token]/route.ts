 ...
 *
 * Security: Uses service role to access storage (bypasses RLS)
...
export async function GET(
  ...
  try {
    ...
    supabaseServer
      ...
      .eq('id', report.id)
      .then(() => console.log('[Report API] View counter incremented'))
      .catch((error) => console.error('[Report API] Failed to increment view counter:', error))
