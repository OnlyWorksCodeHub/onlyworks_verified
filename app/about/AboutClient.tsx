      ...
      <section className="relative py-10 lg:py-14 overflow-hidden border-t border-foreground/10">
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 mt-6">
            <div>
              <h3 className="text-2xl lg:text-3xl font-display tracking-tight mb-3">Is OnlyWorks a resume builder?</h3>
              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
                No. OnlyWorks replaces the resume rather than reformatting it — it turns real work sessions into evidence-backed reports, not another place to type claims about yourself.
              </p>
            </div>
            <div>
              <h3 className="text-2xl lg:text-3xl font-display tracking-tight mb-3">Is this identity or cryptographic verification?</h3>
              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
                No. &quot;Verified&quot; means a skill was corroborated against your real captured work — it isn&apos;t an identity check, a certificate, or cryptography.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="flex flex-wrap items-end justify-between gap-6 mb-12">
            <div>
              ...
              >
                How weird builds<br /><span className="text-muted-foreground">got verified.</span>
              </motion.h2>
            </div>
            <Link
              href="/hackathon"
          ...
          <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-3xl mb-12">
            Builders registered, installed the desktop app, and ran a session while they built. It was fully online. Here&apos;s how the path went, start to finish.
          </p>
          ...
          <ol className="grid lg:grid-cols-2 gap-4">
            {[
              {
                n: '01',
                title: 'Registered for ONLYWEIRD',
                body: 'Builders filled out the registration card to lock in a spot. The event ran fully online.',
                href: '/hackathon',
                cta: 'ONLYWEIRD recap →',
              },
              {
                n: '02',
                title: 'Installed OnlyWorks',
                body: 'Free desktop app for macOS and Windows. Signed in with Google, LinkedIn, or email. Took ~60 seconds.',
                href: '/downloads',
                cta: 'Download →',
              },
              {
                ...
                body: 'Builders opened the app and started a session whenever they sat down to build. It captured their work until they stopped it.',
                href: '#how-it-works',
                cta: 'See how it works →',
              },
              {
                n: '04',
                title: 'Built during the window',
                body: 'Thu 18 Jun 17:00 ET → Sat 20 Jun 17:00 ET — a 48-hour window. Builders shipped whatever weird thing they wanted, fully online.',
                href: '/hackathon',
                cta: 'See recap →',
              },
              {
                n: '05',
                title: 'Submitted their build',
                body: 'From the dashboard. Builders added their demo, README, and repo URL before the window closed.',
                href: '/hackathon',
                cta: 'See recap →',
              },
              {
                n: '06',
                title: 'Generated a report',
                body: 'OnlyWorks turned each session into an AI-written report on their profile, shared with judges and recruiters. Judges scored pitch videos; winners were announced in July.',
                href: '/hackathon',
                cta: 'See a sample →',
              },
            ].map(step => (
