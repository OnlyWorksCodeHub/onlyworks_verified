          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-10">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/teams" className="text-primary hover:text-primary-dark text-base font-medium">Teams</Link>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Remote Teams</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Startups</h3>
              <p className="text-gray-600 mb-4">
