    ...
    <>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-slideUp">
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 text-center mb-2">
                Want deeper insights & analytics?
              </h2>

              <p className="text-gray-600 text-center mb-6">
                Join professionals using OnlyWorks to create verified reports
              </p>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-sm text-gray-700">
                  ...
                  <span>Real-time productivity tracking</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-700">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#5c5ce6]/10 flex items-center justify-center">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-700">
                  ...
                  <span>Tamper-proof verified reports</span>
                </div>
              </div>
      ...
      {showFloatingButton && (
        ...
        >
          ...
          <span className="font-medium">Create Your Reports</span>
        </button>
      )}
    </>
  )
